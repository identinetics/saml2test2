...
CONFIG = {'basic': {'cert_file': './pki/mycert.pem',
                    ...
                    'service': {'sp': {'endpoints': {
                        ...
                        'discovery_response': [('http://localhost:8087/disco',
                                                'urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol')]}}},
                    'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          'coco': {'cert_file': './pki/mycert.pem',
                   'description': 'CoCo SP',
                   'entity_category': [
                       'http://www.geant.net/uri/dataprotection-code-of'
                       '-conduct/v1'],
                   ...
                   'service': {'sp': {'endpoints': {
                       ...
                       'discovery_response': [('http://localhost:8087/disco',
                                      ...
                                      'required_attributes': [
                                          ...
                                          'mail']}},
                   'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          're_eu': {'cert_file': './pki/mycert.pem',
                    'description': 'RE & EU',
                    'entity_category': [
                    ...
                    'service': {'sp': {'endpoints': {
                        ...
                        'discovery_response': [('http://localhost:8087/disco',
                                                'urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol')]}}},
                    'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          're_hei': {'cert_file': './pki/mycert.pem',
                     'description': 'RE & HEI',
                     'entity_category': [
                         'http://www.swamid.se/category/research-and-education',
                     ...
                     'service': {'sp': {'endpoints': {
                         ...
                         'discovery_response': [('http://localhost:8087/disco',
                                                 'urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol')]}}},
                     'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          're_nren': {'cert_file': './pki/mycert.pem',
                      'description': 'RE & NREN',
                      'entity_category': [
                          'http://www.swamid.se/category/research-and'
                          '-education',
                      ...
                      'service': {'sp': {'endpoints': {
                          ...
                          'discovery_response': [('http://localhost:8087/disco',
                                                  'urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol')]}}},
                      'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          're_nren_hei': {'cert_file': './pki/mycert.pem',
                          ...
                          'entity_category': [
                              ...
                              'http://www.swamid.se/category/hei-service'],
                          'entityid':
                              'http://localhost:8087/re_nren_hei/sp.xml',
                          'key_file': './pki/mykey.pem',
                          'name_form':
                              'urn:oasis:names:tc:SAML:2.0:attrname-format:uri',
                          'service': {'sp': {'endpoints': {
                              ...
                              'discovery_response': [
                                  ('http://localhost:8087/disco',
                                   'urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol')]}}},
                          'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          're_nren_sfs': {'cert_file': './pki/mycert.pem',
                          ...
                          'entity_category': [
                              ...
                              'http://www.swamid.se/category/nren-service'],
                          'entityid':
                              'http://localhost:8087/re_nren_sfs/sp.xml',
                          'key_file': './pki/mykey.pem',
                          'name_form':
                              'urn:oasis:names:tc:SAML:2.0:attrname-format:uri',
                          'service': {'sp': {'endpoints': {
                              ...
                              'discovery_response': [
                                  ('http://localhost:8087/disco',
                                   'urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol')]}}},
                          'xmlsec_binary': '/opt/local/bin/xmlsec1'},
          'required': {'cert_file': './pki/mycert.pem',
