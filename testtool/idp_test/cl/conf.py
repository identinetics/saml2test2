METADATA = [{'metadata': [('./local_idp.xml',)], 'class': 'saml2.mdstore.MetaDataFile'}]
...
CONFIG = { 'basic': { 'cert_file': './pki/mycert.pem',
             ...
             'service': { 'sp': { 'endpoints': { 'assertion_consumer_service': [ ( 'http://localhost:8087/acs/redirect',
  ...
  'coco': { 'cert_file': './pki/mycert.pem',
            'description': 'CoCo SP',
            'entity_category': [ 'http://www.geant.net/uri/dataprotection-code-of-conduct/v1'],
  ...
  'rs': { 'cert_file': './pki/mycert.pem',
          'description': 'RS SP',
          'entity_category': [ 'http://refeds.org/category/research-and-scholarship'],
